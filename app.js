...
// 4b result
console.log('Uncontroversial Pizza Toppings:', uncontroversialPizzaToppings);
...
const userProfile = {
  ...
  age: 17,
  email: 'ted@wyldstallionz.com',
};

const username = userProfile[propertyName];
// 6d result
...
console.log('The pizza is ' + taste + ".");
...
const localLangConfig = 'de'; // Change to 'es', 'fr', etc., or leave it `null`.
